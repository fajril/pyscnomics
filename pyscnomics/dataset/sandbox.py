...
#
# # psc_table['Tax of FTP'] = psc._gas_tax_of_ftp
#
# #
# # psc_table['Tax Payment'] = psc._gas_tax_payment
# # psc_table['Contractor Take'] = psc._gas_contractor_take
# # psc_table['Gov Take'] = psc._gas_government_take
#
#
