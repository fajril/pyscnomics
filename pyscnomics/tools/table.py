...
def get_table(contract: CostRecovery | GrossSplit | Transition) -> tuple[pd.DataFrame, pd.DataFrame, pd.DataFrame]:
    """
    ...
    if isinstance(contract, CostRecovery):
        ...
        if isinstance(contract.contract2, CostRecovery):
            psc_table_oil = pd.DataFrame()
            psc_table_oil['Year'] = contract.contract2.project_years
            psc_table_oil['Lifting'] = contract._contract2_transitioned._oil_lifting.get_lifting_rate_arr()
            psc_table_oil['Price'] = contract._contract2_transitioned._oil_wap_price
            psc_table_oil['Revenue'] = contract._contract2_transitioned._oil_revenue
            psc_table_oil['Depreciable'] = contract._contract2_transitioned._oil_tangible_expenditures
            psc_table_oil['Intangible'] = contract._contract2_transitioned._oil_intangible_expenditures
            psc_table_oil['Opex'] = contract._contract2_transitioned._oil_opex_expenditures
            psc_table_oil['ASR'] = contract._contract2_transitioned._oil_asr_expenditures
            psc_table_oil['Depreciation'] = contract._contract2_transitioned._oil_depreciation
            psc_table_oil['Non_Capital'] = contract._contract2_transitioned._oil_non_capital
            psc_table_oil['FTP'] = contract._contract2_transitioned._oil_ftp
            psc_table_oil['FTP_CTR'] = contract._contract2_transitioned._oil_ftp_ctr
            psc_table_oil['FTP_GOV'] = contract._contract2_transitioned._oil_ftp_gov
            psc_table_oil['Investment_Credit'] = contract._contract2_transitioned._oil_ic_paid
            psc_table_oil['Unrecovered_Cost'] = contract._contract2_transitioned._oil_unrecovered_before_transfer
            psc_table_oil['Cost_to_Be_Recovered'] = contract._contract2_transitioned._oil_cost_to_be_recovered
            psc_table_oil['Cost_Recovery'] = contract._contract2_transitioned._oil_cost_recovery
            psc_table_oil['ETS_Before_Transfer'] = contract._contract2_transitioned._oil_ets_before_transfer
            psc_table_oil['Transfer_to_Gas'] = contract._contract2_transitioned._transfer_to_gas
            psc_table_oil['Unrec_after_Transfer'] = contract._contract2_transitioned._oil_unrecovered_after_transfer
            psc_table_oil['Cost_To_Be_Recovered_After_TF'] = contract._contract2_transitioned._oil_cost_to_be_recovered_after_tf
            psc_table_oil['Cost_Recovery_After_TF'] = contract._contract2_transitioned._oil_cost_recovery_after_tf
            psc_table_oil['ETS_After_Transfer'] = contract._contract2_transitioned._oil_ets_after_transfer
            psc_table_oil['Contractor_Share'] = contract._contract2_transitioned._oil_contractor_share
            psc_table_oil['Government_Share'] = contract._contract2_transitioned._oil_government_share
            psc_table_oil['DMO_Volume'] = contract._contract2_transitioned._oil_dmo_volume
            psc_table_oil['DMO_Fee'] = contract._contract2_transitioned._oil_dmo_fee
            psc_table_oil['DDMO'] = contract._contract2_transitioned._oil_ddmo
            psc_table_oil['Taxable_Income'] = contract._contract2_transitioned._oil_taxable_income
            psc_table_oil['Tax_Payment'] = contract._contract2_transitioned._oil_tax_payment
            psc_table_oil['Contractor_Net_Share'] = contract._contract2_transitioned._oil_ctr_net_share
            ...
            psc_table_gas['Lifting'] = contract._contract2_transitioned._gas_lifting.get_lifting_rate_arr()
            psc_table_gas['Price'] = contract._contract2_transitioned._gas_wap_price
            psc_table_gas['Revenue'] = contract._contract2_transitioned._gas_revenue
            psc_table_gas['Depreciable'] = contract._contract2_transitioned._gas_tangible_expenditures
            psc_table_gas['Intangible'] = contract._contract2_transitioned._gas_intangible_expenditures
            psc_table_gas['Opex'] = contract._contract2_transitioned._gas_opex_expenditures
            psc_table_gas['ASR'] = contract._contract2_transitioned._gas_asr_expenditures
            psc_table_gas['Depreciation'] = contract._contract2_transitioned._gas_depreciation
            psc_table_gas['Non_Capital'] = contract._contract2_transitioned._gas_non_capital
            psc_table_gas['FTP'] = contract._contract2_transitioned._gas_ftp
            psc_table_gas['FTP_CTR'] = contract._contract2_transitioned._gas_ftp_ctr
            psc_table_gas['FTP_GOV'] = contract._contract2_transitioned._gas_ftp_gov
            psc_table_gas['Investment_Credit'] = contract._contract2_transitioned._gas_ic_paid
            psc_table_gas['Unrecovered_Cost'] = contract._contract2_transitioned._gas_unrecovered_before_transfer
            psc_table_gas['Cost_to_Be_Recovered'] = contract._contract2_transitioned._gas_cost_to_be_recovered
            psc_table_gas['Cost_Recovery'] = contract._contract2_transitioned._gas_cost_recovery
            psc_table_gas['ETS_Before_Transfer'] = contract._contract2_transitioned._gas_ets_before_transfer
            psc_table_gas['Transfer_to_Oil'] = contract._contract2_transitioned._transfer_to_oil
            psc_table_gas['Unrec_after_Transfer'] = contract._contract2_transitioned._gas_unrecovered_after_transfer
            psc_table_gas['Cost_To_Be_Recovered_After_TF'] = contract._contract2_transitioned._gas_cost_to_be_recovered_after_tf
            psc_table_gas['Cost_Recovery_After_TF'] = contract._contract2_transitioned._gas_cost_recovery_after_tf
            psc_table_gas['ETS_After_Transfer'] = contract._contract2_transitioned._gas_ets_after_transfer
            psc_table_gas['Contractor_Share'] = contract._contract2_transitioned._gas_contractor_share
            psc_table_gas['Government_Share'] = contract._contract2_transitioned._gas_government_share
            psc_table_gas['DMO_Volume'] = contract._contract2_transitioned._gas_dmo_volume
            psc_table_gas['DMO_Fee'] = contract._contract2_transitioned._gas_dmo_fee
            psc_table_gas['DDMO'] = contract._contract2_transitioned._gas_ddmo
            psc_table_gas['Taxable_Income'] = contract._contract2_transitioned._gas_taxable_income
            psc_table_gas['Tax_Payment'] = contract._contract2_transitioned._gas_tax_payment
            psc_table_gas['Contractor_Net_Share'] = contract._contract2_transitioned._gas_ctr_net_share
            ...
            psc_table_consolidated['Lifting_oil'] = contract._contract2_transitioned._oil_lifting.get_lifting_rate_arr()
            psc_table_consolidated['Lifting_gas'] = contract._contract2_transitioned._gas_lifting.get_lifting_rate_arr()
            psc_table_consolidated['C_Revenue'] = contract._contract2_transitioned._consolidated_revenue
            psc_table_consolidated['C_Depreciable'] = contract._contract2_transitioned._consolidated_tangible
            psc_table_consolidated['C_Intangible'] = contract._contract2_transitioned._consolidated_intangible
            psc_table_consolidated['C_Opex'] = contract._contract2_transitioned._consolidated_opex
            psc_table_consolidated['C_ASR'] = contract._contract2_transitioned._consolidated_asr
            psc_table_consolidated['C_Depreciation'] = contract._contract2_transitioned._consolidated_depreciation
            psc_table_consolidated['C_Non_Capital'] = contract._contract2_transitioned._consolidated_non_capital
            psc_table_consolidated['C_FTP'] = contract._contract2_transitioned._consolidated_ftp
            psc_table_consolidated['C_FTP_CTR'] = contract._contract2_transitioned._consolidated_ftp_ctr
            psc_table_consolidated['C_FTP_GOV'] = contract._contract2_transitioned._consolidated_ftp_gov
            psc_table_consolidated['C_IC'] = contract._contract2_transitioned._consolidated_ic
            psc_table_consolidated[
                'C_Unrecovered_before_TF'] = contract._contract2_transitioned._consolidated_unrecovered_before_transfer
            psc_table_consolidated['C_Cost_Recovery'] = contract._contract2_transitioned._consolidated_cost_recovery_before_transfer
            psc_table_consolidated['C_ETS_before_TF'] = contract._contract2_transitioned._consolidated_ets_before_transfer
            psc_table_consolidated['C_Unrecovered_after_TF'] = contract._contract2_transitioned._consolidated_unrecovered_after_transfer
            psc_table_consolidated[
                'C_Cost_to_be_Recovered_after_TF'] = contract._contract2_transitioned._consolidated_cost_to_be_recovered_after_tf
            psc_table_consolidated['C_Cost_Recovery_after_TF'] = contract._contract2_transitioned._consolidated_cost_recovery_after_tf
            psc_table_consolidated['C_ETS_after_TF'] = contract._contract2_transitioned._consolidated_ets_after_transfer
            psc_table_consolidated['C_Contractor_Share'] = contract._contract2_transitioned._consolidated_contractor_share
            psc_table_consolidated['C_Government_Share'] = contract._contract2_transitioned._consolidated_government_share
            psc_table_consolidated['C_DMO_Volume'] = contract._contract2_transitioned._consolidated_dmo_volume
            psc_table_consolidated['C_DMO_Fee'] = contract._contract2_transitioned._consolidated_dmo_fee
            psc_table_consolidated['C_DDMO'] = contract._contract2_transitioned._consolidated_ddmo
            psc_table_consolidated['C_Taxable_Income'] = contract._contract2_transitioned._consolidated_taxable_income
            psc_table_consolidated['C_Tax_Due'] = contract._contract2_transitioned._consolidated_tax_due
            psc_table_consolidated['C_Unpaid_Tax_Balance'] = contract._contract2_transitioned._consolidated_unpaid_tax_balance
            psc_table_consolidated['C_Tax_Payment'] = contract._contract2_transitioned._consolidated_tax_payment
            psc_table_consolidated['C_CTR_Net_Share'] = contract._contract2_transitioned._consolidated_ctr_net_share
            psc_table_consolidated['C_Contractor_Take'] = contract._contract2_transitioned._consolidated_contractor_take
            ...
            psc_table_oil = pd.DataFrame()
            psc_table_oil['Years'] = contract._contract2_transitioned.project_years
            psc_table_oil['lifting'] = contract._contract2_transitioned._oil_lifting.get_lifting_rate_arr()
            psc_table_oil['Price'] = contract._contract2_transitioned._oil_wap_price
            psc_table_oil['Depreciable'] = contract._contract2_transitioned._oil_tangible_expenditures
            psc_table_oil['Intangible'] = contract._contract2_transitioned._oil_intangible_expenditures
            ...
            psc_table_oil['ASR'] = contract._contract2_transitioned._oil_asr_expenditures
            psc_table_oil['Revenue'] = contract._contract2_transitioned._oil_revenue
            psc_table_oil['BaseSplit'] = contract._contract2_transitioned._oil_base_split
            psc_table_oil['Variable_Split'] = contract._contract2_transitioned._var_split_array
            psc_table_oil['Progressive_Split'] = contract._contract2_transitioned._oil_prog_split
            psc_table_oil['Contractor_Split'] = contract._contract2_transitioned._oil_ctr_split
            psc_table_oil['Contractor_Share'] = contract._contract2_transitioned._oil_ctr_share_before_transfer
            psc_table_oil['Government_Share'] = contract._contract2_transitioned._oil_gov_share
            psc_table_oil['Depreciation'] = contract._contract2_transitioned._oil_depreciation
            psc_table_oil['Non_Capital'] = contract._contract2_transitioned._oil_non_capital
            psc_table_oil['Total_Expenses'] = contract._contract2_transitioned._oil_total_expenses
            psc_table_oil['Cost_To_Be_Deducted'] = contract._contract2_transitioned._oil_cost_tobe_deducted
            psc_table_oil['Carry_Forward_Cost'] = contract._contract2_transitioned._oil_carward_deduct_cost
            psc_table_oil['Deductible_Cost'] = contract._contract2_transitioned._oil_deductible_cost
            psc_table_oil['Transfer_To_Gas'] = contract._contract2_transitioned._transfer_to_gas
            psc_table_oil['Carry_Forward_Cost_after_TF'] = contract._contract2_transitioned._oil_carward_cost_aftertf
            psc_table_oil['CTR_Share_After_TF'] = contract._contract2_transitioned._oil_ctr_share_after_transfer
            psc_table_oil['CTR_Net_Operating_Profit'] = contract._contract2_transitioned._oil_net_operating_profit
            psc_table_oil['DMO_Volume'] = contract._contract2_transitioned._oil_dmo_volume
            psc_table_oil['DMO_Fee'] = contract._contract2_transitioned._oil_dmo_fee
            psc_table_oil['DDMO'] = contract._contract2_transitioned._oil_ddmo
            psc_table_oil['Taxable_Income'] = contract._contract2_transitioned._oil_taxable_income
            psc_table_oil['Tax'] = contract._contract2_transitioned._oil_tax
            psc_table_oil['Net_CTR_Share'] = contract._contract2_transitioned._oil_ctr_net_share
            ...
            psc_table_gas['ASR'] = contract._contract2_transitioned._gas_asr_expenditures
            psc_table_gas['Revenue'] = contract._contract2_transitioned._gas_revenue
            psc_table_gas['Base_Split'] = contract._contract2_transitioned._gas_base_split
            psc_table_gas['Variable_Split'] = contract._contract2_transitioned._var_split_array
            psc_table_gas['Progressive_Split'] = contract._contract2_transitioned._gas_prog_split
            psc_table_gas['Contractor_Split'] = contract._contract2_transitioned._gas_ctr_split
            psc_table_gas['Contractor_Share'] = contract._contract2_transitioned._gas_ctr_share_before_transfer
            psc_table_gas['Government_Share'] = contract._contract2_transitioned._gas_gov_share
            psc_table_gas['Depreciation'] = contract._contract2_transitioned._gas_depreciation
            psc_table_gas['Non_Capital'] = contract._contract2_transitioned._gas_non_capital
            psc_table_gas['Total_Expenses'] = contract._contract2_transitioned._gas_total_expenses
            psc_table_gas['Cost_To_Be_Deducted'] = contract._contract2_transitioned._gas_cost_tobe_deducted
            psc_table_gas['Carry_Forward_Cost'] = contract._contract2_transitioned._gas_carward_deduct_cost
            psc_table_gas['Deductible_Cost'] = contract._contract2_transitioned._gas_deductible_cost
            psc_table_gas['Transfer_To_Oil'] = contract._contract2_transitioned._transfer_to_oil
            psc_table_gas['Carry_Forward_CostafterTF'] = contract._contract2_transitioned._gas_carward_cost_aftertf
            psc_table_gas['CTR_Share_After_TF'] = contract._contract2_transitioned._gas_ctr_share_after_transfer
            psc_table_gas['CTR_Net_Operating_Profit'] = contract._contract2_transitioned._gas_net_operating_profit
            psc_table_gas['DMO_Volume'] = contract._contract2_transitioned._gas_dmo_volume
            psc_table_gas['DMO_Fee'] = contract._contract2_transitioned._gas_dmo_fee
            psc_table_gas['DDMO'] = contract._contract2_transitioned._gas_ddmo
            psc_table_gas['Taxable_Income'] = contract._contract2_transitioned._gas_taxable_income
            psc_table_gas['Tax'] = contract._contract2_transitioned._gas_tax
            psc_table_gas['Net_CTR_Share'] = contract._contract2_transitioned._gas_ctr_net_share
            ...
            psc_table_consolidated = pd.DataFrame()
            psc_table_consolidated['Years'] = contract.project_years
            psc_table_consolidated['C_Lifting_Oil'] = contract._contract2_transitioned._oil_lifting.get_lifting_rate_arr()
            psc_table_consolidated['C_Lifting_Gas'] = contract._contract2_transitioned._gas_lifting.get_lifting_rate_arr()
            psc_table_consolidated['C_Revenue'] = contract._contract2_transitioned._consolidated_revenue
            psc_table_consolidated['C_Government_Share'] = contract._contract2_transitioned._consolidated_ctr_share_before_tf
            psc_table_consolidated['C_Contractor_Share'] = contract._contract2_transitioned._consolidated_gov_share_before_tf
            psc_table_consolidated['C_Depreciation'] = contract._contract2_transitioned._consolidated_depreciation
            psc_table_consolidated['C_Opex'] = contract._contract2_transitioned._consolidated_opex
            psc_table_consolidated['C_ASR'] = contract._contract2_transitioned._consolidated_asr
            psc_table_consolidated['C_Non_Capital'] = contract._contract2_transitioned._consolidated_non_capital
            psc_table_consolidated['C_Total_Expenses'] = contract._contract2_transitioned._consolidated_total_expenses
            psc_table_consolidated['C_Cost_To_Be_Deducted'] = contract._contract2_transitioned._consolidated_cost_tobe_deducted
            psc_table_consolidated['C_Carry_Forward_Cost'] = contract._contract2_transitioned._consolidated_carward_deduct_cost
            psc_table_consolidated['C_Deductible_Cost'] = contract._contract2_transitioned._consolidated_deductible_cost
            psc_table_consolidated['C_Carry_Forward_Cost_after_TF'] = contract._contract2_transitioned._consolidated_carward_cost_aftertf
            psc_table_consolidated['C_CTR_Share_After'] = contract._contract2_transitioned._consolidated_ctr_share_after_transfer
            psc_table_consolidated['C_CTR_Net_Operating_Profit'] = contract._contract2_transitioned._consolidated_net_operating_profit
            psc_table_consolidated['C_DMO_Volume'] = contract._contract2_transitioned._consolidated_dmo_volume
            psc_table_consolidated['C_DMO_Fee'] = contract._contract2_transitioned._consolidated_dmo_fee
            psc_table_consolidated['C_DDMO'] = contract._contract2_transitioned._consolidated_ddmo
            psc_table_consolidated['C_Taxable_Income'] = contract._contract2_transitioned._consolidated_taxable_income
            psc_table_consolidated['C_Tax'] = contract._contract2_transitioned._consolidated_tax_payment
            psc_table_consolidated['C_Net_CTR_Share'] = contract._contract2_transitioned._consolidated_ctr_net_share
            psc_table_consolidated['C_CashFlow'] = contract._contract2_transitioned._consolidated_cashflow
            psc_table_consolidated['C_Government_Take'] = contract._contract2_transitioned._consolidated_government_take
        ...
        psc_table_consolidated['Opex'] = (contract._oil_opex_expenditures +
                                          contract._gas_opex_expenditures)
        psc_table_consolidated['ASR'] = (contract._oil_asr_expenditures +
                                         contract._gas_asr_expenditures)
