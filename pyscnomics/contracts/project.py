...
class BaseProject:
    ...
    def _get_oil_lifting(self):
        ...
        if FluidType.OIL not in fluid_types:
            return Lifting(
                start_year=self.start_date.year,
                end_year=self.end_date.year,
                lifting_rate=np.array([0]),
                price=np.array([0]),
                prod_year=np.array([0]),
    ...
    def _get_oil_tangible(self):
        ...
        fluid_types = [cst.fluid_type for cst in self.tangible_cost]
    ...
    def _get_oil_intangible(self):
        ...
        fluid_types = [cst.fluid_type for cst in self.intangible_cost]
    ...
    def _get_oil_opex(self):
        ...
        fluid_types = [cst.fluid_type for cst in self.opex]
    ...
    def _get_oil_asr(self):
        ...
        fluid_types = [cst.fluid_type for cst in self.asr_cost]
