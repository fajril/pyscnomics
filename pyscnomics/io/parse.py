...
class InitiateContract:
    ...
    def _get_single_contract_project(self) -> tuple:
        ...
        self.psc = BaseProject(
            ...
            tangible_cost=self.data.capital_cost_aggregate,
    ...
    def _get_transition_contract_cr_to_cr(self) -> tuple:
        ...
        self.psc = {
            "PSC 1": CostRecovery(
                ...
                tangible_cost=self.data.capital_cost_aggregate["PSC 1"],
            ...
            "PSC 2": CostRecovery(
                ...
                tangible_cost=self.data.capital_cost_aggregate["PSC 2"],
