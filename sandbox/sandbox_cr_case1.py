...
# psc_table['IC Paid'] = psc._oil_ic_paid
...
# base = np.array(load_testing(dataset_type='case1', key='gas_unrec_after_transfer'))
# engine = psc._gas_unrecovered_after_transfer
